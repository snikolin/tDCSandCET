function data = sn_CETreadTMSiEEG(filename)
% Read .poly5 data and convert it to a .mat file format

% Parameters
EEG_CH  = [1:18,35,20:32]; % Channel 19 is replaced by 35.
ECG_CH  = 65;
MRKR_CH = 73;
